package com.vladgad.qnb.model.commandhelpers



import com.vladgad.qnb.model.EvmTag
import com.vladgad.qnb.model.EvmTag.TagValueTypeEnum
import com.vladgad.qnb.utils.BytesUtils.bytesToStringNoSpace
/**
 ...
 */
object EmvTags {
    val AID_CARD = EvmTag("4f", EvmTag.TagValueTypeEnum.BINARY, "Application Identifier (AID) - card", "Identifies the application as described in ISO/IEC 7816-5")
    ...
    val TRACK_2_EQV_DATA = EvmTag("57", EvmTag.TagValueTypeEnum.BINARY, "Track 2 Equivalent Data", "Contains the data elements of track 2 according to ISO/IEC 7813, excluding start sentinel, end sentinel, and Longitudinal Redundancy Check (LRC)")
